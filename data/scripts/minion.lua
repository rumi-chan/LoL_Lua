...
L0_1 = 28
FIRST_WAVE_GHOST_TIME_OUTERLANES = L0_1
L0_1 = DoLuaShared
L1_1 = "ObjectTags"
L0_1(L1_1)
L0_1 = DoLuaShared
...
function L0_1()
  ...
  L0_2 = FIRST_WAVE_GHOST_TIME
  L1_2 = GetMissionTime
  L1_2 = L1_2()
  L2_2 = FIRST_WAVE_TIME
  if L1_2 < L2_2 then
    L1_2 = SetTargetAcquisitionMode
    L2_2 = TARGET_ACQUISITION_MODE_ASLEEP
    L1_2(L2_2)
    L1_2 = SetGhostedForAllies
    L2_2 = true
    L1_2(L2_2)
    L1_2 = GetMinionLane
    L1_2 = L1_2()
    L2_2 = CENTER_LANE
    if L1_2 ~= L2_2 then
      L0_2 = FIRST_WAVE_GHOST_TIME_OUTERLANES
    end
    L1_2 = InitTimer
    L2_2 = "TimerDisableGhosting"
    L3_2 = L0_2
    L4_2 = true
    L1_2(L2_2, L3_2, L4_2)
  ...
  L1_2 = InitTimer
  L2_2 = "TimerWaitForAttackFinish"
  L3_2 = DELAY_WAIT_FOR_ATTACK
  L4_2 = true
  L1_2(L2_2, L3_2, L4_2)
  L1_2 = StopTimer
  L2_2 = "TimerWaitForAttackFinish"
...
function L0_1()
  ...
  if L1_2 ~= L2_2 then
    ...
    if L1_2 == L2_2 then
      ...
      L2_2(L3_2)
      L2_2 = FindTargetInWakeUpRangeWithFilter
      L3_2 = {}
      L4_2 = {}
      L5_2 = UnitTagIndicies
      L5_2 = L5_2.Special_LaneMinionIgnores
      L4_2[1] = L5_2
      L2_2 = L2_2(L3_2, L4_2)
      ...
      if L2_2 ~= nil then
        ...
        L7_2 = L7_2.Special_LaneMinionIgnores
        L5_2[1] = L6_2
        L5_2[2] = L7_2
        L3_2 = L3_2(L4_2, L5_2)
        L0_2 = L3_2
      ...
      L5_2 = {}
      L6_2 = UnitTagIndicies
      L6_2 = L6_2.Special_LaneMinionIgnores
      L5_2[1] = L6_2
      L3_2 = L3_2(L4_2, L5_2)
      L0_2 = L3_2
    end
