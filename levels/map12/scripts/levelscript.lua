...
function L0_1()
  ...
  if L3_2 == "FIRSTBLOOD" then
    L4_2 = {}
    L4_2.DefaultNumPerWave = 3
    L4_2.ArmorMax = 16
    L4_2.Armor = 0
    L4_2.ArmorUpgrade = 0
    L4_2.ArmorUpgradeGrowth = 0.085
    L4_2.MagicResistance = 0
    L4_2.MagicResistanceUpgrade = 0.625
    L4_2.HPBonus = 0
    L4_2.MaxBonus = 845
    L4_2.HPUpgrade = 22
    L4_2.HPUpgradeGrowth = 0.3
    L4_2.HPUpgradeLate = 10.25
    L4_2.HPUpgradeGrowthLate = 0
    L4_2.HPInhibitor = 0
    L4_2.DamageMax = 68
    L4_2.DamageBonus = 0
    L4_2.DamageUpgrade = 0
    L4_2.DamageUpgradeLate = 3.41
    L4_2.DamageInhibitor = 0
    L4_2.ExpGiven = 64
    L4_2.ExpBonus = 0
    L4_2.ExpUpgrade = 0
    L4_2.ExpInhibitor = 0
    L4_2.GoldGiven = 36.75
    L4_2.GoldGivenBase = 36.75
    L4_2.GoldBonus = 0
    L4_2.GoldUpgrade = 0
    L4_2.GoldInhibitor = 0
    L4_2.GoldShared = 0
    L4_2.GoldShareUpgrade = 0
    L4_2.GoldMaximumBonus = 0
    L4_2.LocalGoldGiven = 0
    L4_2.LocalGoldBonus = 0
    L4_2.MoveSpeedBaseIncrease = 0
    L5_2 = {}
    L5_2.DefaultNumPerWave = 3
    L5_2.ArmorMax = 0
    L5_2.Armor = 0
    L5_2.ArmorUpgrade = 0
    L5_2.ArmorUpgradeGrowth = 0
    L5_2.MagicResistance = 0
    L5_2.MagicResistanceUpgrade = 1
    L5_2.HPBonus = 0
    L5_2.MaxBonus = 195
    L5_2.HPUpgrade = 6
    L5_2.HPUpgradeGrowth = 0
    L5_2.HPUpgradeLate = 2.25
    L5_2.HPUpgradeGrowthLate = 0
    L5_2.HPInhibitor = 0
    L5_2.DamageMax = 97
    L5_2.DamageBonus = 0
    L5_2.DamageUpgrade = 1.5
    L5_2.DamageUpgradeLate = 3
    L5_2.DamageInhibitor = 0
    L5_2.ExpGiven = 32
    L5_2.ExpBonus = 0
    L5_2.ExpUpgrade = 0
    L5_2.ExpInhibitor = 0
    L5_2.GoldGiven = 24.5
    L5_2.GoldGivenBase = 24.5
    L5_2.GoldBonus = 0
    L5_2.GoldUpgrade = 0
    L5_2.GoldInhibitor = 0
    L5_2.GoldShared = 0
    L5_2.GoldShareUpgrade = 0
    L5_2.GoldMaximumBonus = 0
    L5_2.LocalGoldGiven = 0
    L5_2.LocalGoldBonus = 0
    L5_2.MoveSpeedBaseIncrease = 0
    L6_2 = {}
    L6_2.DefaultNumPerWave = 0
    L6_2.ArmorMax = 0
    L6_2.Armor = 0
    L6_2.ArmorUpgrade = 0
    L6_2.ArmorUpgradeGrowth = 0
    L6_2.MagicResistance = 0
    L6_2.MagicResistanceUpgrade = 1.5
    L6_2.HPBonus = 0
    L6_2.MaxBonus = 10000
    L6_2.HPUpgrade = 62
    L6_2.HPUpgradeGrowth = 0
    L6_2.HPUpgradeLate = 25
    L6_2.HPUpgradeGrowthLate = 0
    L6_2.HPInhibitor = 0
    L6_2.DamageMax = 10000
    L6_2.DamageBonus = 0
    L6_2.DamageUpgrade = 1.5
    L6_2.DamageUpgradeLate = 0
    L6_2.DamageInhibitor = 0
    L6_2.ExpGiven = 100
    L6_2.ExpBonus = 0
    L6_2.ExpUpgrade = 0
    L6_2.ExpInhibitor = 0
    L6_2.GoldGiven = 156.275
    L6_2.GoldGivenBase = 156.275
    L6_2.GoldBonus = 0
    L6_2.GoldUpgrade = 10.5
    L6_2.GoldInhibitor = 0
    L6_2.GoldShared = 0
    L6_2.GoldShareUpgrade = 0
    L6_2.GoldMaximumBonus = 33
    L6_2.LocalGoldGiven = 0
    L6_2.LocalGoldBonus = 0
    L6_2.MoveSpeedBaseIncrease = 0
    L7_2 = {}
    L7_2.ExpGiven = 100
    L7_2.GoldGiven = 27
    L7_2.GoldUpgrade = 0
  ...
  if L3_2 == "TUTORIAL" then
    ...
    L4_2 = PreloadCharacterWithCFGSkin
    L5_2 = "HA_AP_BannerMidBridge"
    L6_2 = "LevelProp_HA_AP_BannerMidBridge"
    L7_2 = "skinID"
    L4_2(L5_2, L6_2, L7_2)
    L4_2 = PreloadCharacterWithCFGSkin
    L5_2 = "HA_AP_BridgeLaneStatue"
    L6_2 = "LevelProp_HA_AP_BridgeLaneStatue1"
    L7_2 = "skinID"
    L4_2(L5_2, L6_2, L7_2)
    L4_2 = PreloadCharacterWithCFGSkin
    L5_2 = "HA_AP_Chains"
    L6_2 = "LevelProp_HA_AP_Chains1"
    L7_2 = "skinID"
    L4_2(L5_2, L6_2, L7_2)
    L4_2 = PreloadCharacterWithCFGSkin
    L5_2 = "HA_AP_Chains_Long"
    L6_2 = "LevelProp_HA_AP_Chains_Long"
    L7_2 = "skinID"
    L4_2(L5_2, L6_2, L7_2)
    L4_2 = PreloadCharacterWithCFGSkin
    L5_2 = "Turret"
    ...
    L6_2 = "Turret_ChaosTurretShrine"
    L7_2 = "skinID"
    L4_2(L5_2, L6_2, L7_2)
    L4_2 = PreloadCharacterWithCFGSkin
    L5_2 = "HA_AP_Cutaway"
    L6_2 = "LevelProp_HA_AP_Cutaway"
    L7_2 = "skinID"
    L4_2(L5_2, L6_2, L7_2)
    L4_2 = PreloadCharacterWithCFGSkin
    L5_2 = "HA_AP_Hermit"
    L6_2 = "LevelProp_HA_AP_Hermit"
    L7_2 = "skinID"
    L4_2(L5_2, L6_2, L7_2)
    L4_2 = PreloadCharacterWithCFGSkin
    L5_2 = "HA_AP_HeroTower"
    L6_2 = "LevelProp_HA_AP_HeroTower"
    L7_2 = "skinID"
    L4_2(L5_2, L6_2, L7_2)
    L4_2 = PreloadCharacterWithCFGSkin
    L5_2 = "Turret"
    ...
    L4_2(L5_2, L6_2, L7_2)
    L4_2 = PreloadCharacterWithCFGSkin
    L5_2 = "HA_AP_OrderTurretShrine"
    L6_2 = "Turret_OrderTurretShrine"
    L7_2 = "skinID"
    L4_2(L5_2, L6_2, L7_2)
    L4_2 = PreloadCharacter
    L5_2 = "HA_AP_Poro"
    ...
    L4_2 = PreloadCharacterWithCFGSkin
    L5_2 = "HA_AP_ShpSouth"
    L6_2 = "LevelProp_HA_AP_ShpSouth"
    L7_2 = "skinID"
    L4_2(L5_2, L6_2, L7_2)
    L4_2 = PreloadCharacterWithCFGSkin
    L5_2 = "HA_AP_Viking"
    L6_2 = "LevelProp_HA_AP_Viking"
    L7_2 = "skinID"
    L4_2(L5_2, L6_2, L7_2)
    L4_2 = PreloadSpell
    ...
    if L3_2 == "FIRSTBLOOD" then
      ...
      L4_2(L5_2)
      L4_2 = PreloadSpell
      L5_2 = "HowlingAbyssAuraFirstBlood"
      L4_2(L5_2)
      L4_2 = PreloadSpell
      L5_2 = "FirstBloodShopDisableNoParticle"
      L4_2(L5_2)
      L4_2 = PreloadSpell
      L5_2 = "SuperRecall"
      L4_2(L5_2)
...
function L0_1(A0_2, A1_2, A2_2, A3_2, A4_2)
  ...
  L8_2 = L8_2.Cannon
  L9_2 = ResetToDefaultWaveCounts
  L10_2 = L5_2.MinionInfoTable
  L9_2(L10_2)
  L9_2 = A1_2 + 1
  L9_2 = L9_2 + L6_2
  L10_2 = CANNON_MINION_SPAWN_FREQUENCY
  L9_2 = L9_2 % L10_2
  if L9_2 == 0 and A1_2 ~= 1 then
    L9_2 = L8_2.NumPerWave
    L9_2 = L9_2 + 1
    L8_2.NumPerWave = L9_2
  end
  L9_2 = LAST_WAVE
  if A4_2 ~= L9_2 then
    L9_2 = 6
    BARRACKSCOUNT = L9_2
    L9_2 = MAX_MINIONS_EVER
    L10_2 = GetTotalTeamMinionsSpawned
    L10_2 = L10_2()
    L9_2 = L9_2 - L10_2
    totalMinionsRemaining = L9_2
    LAST_WAVE = A4_2
  end
  L9_2 = L5_2.WillSpawnSuperMinion
  if L9_2 == 1 then
    L7_2.NumPerWave = 1
    L8_2.NumPerWave = 0
  end
  L9_2 = {}
  L9_2.NewFormat = true
  L10_2 = L5_2.SpawnOrderMinionNames
  L9_2.SpawnOrderMinionNames = L10_2
  L10_2 = L5_2.IsDestroyed
  L9_2.IsDestroyed = L10_2
  L10_2 = SpawnTable
  L10_2 = L10_2.ExpRadius
  L9_2.ExperienceRadius = L10_2
  L10_2 = SpawnTable
  L10_2 = L10_2.GoldRadius
  L9_2.GoldRadius = L10_2
  L10_2 = L5_2.MinionInfoTable
  L9_2.MinionInfoTable = L10_2
  ReturnTable = L9_2
  L9_2 = ReturnTable
  return L9_2
end
